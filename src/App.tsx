...
export const App = () => {
  ...
  return (
    <div className="relative min-h-screen bg-app-bg text-app-text-primary font-sans antialiased overflow-x-clip selection:bg-app-text-primary selection:text-app-bg">
